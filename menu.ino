...
static const char PROGMEM timeMeasureMenuStrings0[] = "Stop Watch";
static const char PROGMEM timeMeasureMenuStrings1[] = "Timer";

static const char* PROGMEM timeMeasureMenuStrings[] = 
{
  timeMeasureMenuStrings0,
  timeMeasureMenuStrings1,  
};

const menu_info timeMeasureMenuApp =
{
  2,
  timeMeasureMenuStrings
  date
}

const menu_info menuList[] = {mainMenuInfo, dateTimeMenuInfo, timeMeasureMenuApp};
